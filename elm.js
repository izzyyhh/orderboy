...
var $author$project$Main$Product = F4(
	function (name, price, id, image) {
		return {az: id, Y: image, J: name, M: price};
	});
var $author$project$Main$availableProducts = _List_fromArray(
	[
		A4($author$project$Main$Product, 'Cappucino', 2.5, '1', './images/coffee_640.jpg'),
		A4($author$project$Main$Product, 'Fresh Orange Juice', 2, '3', './images/orange_640.jpg'),
		A4($author$project$Main$Product, 'Chocolate Milk', 2, '4', './images/hot-chocolate_640.jpg'),
		A4($author$project$Main$Product, 'Brownie', 3.5, '2', './images/brownie_640.jpg'),
		A4($author$project$Main$Product, 'Cheesecake', 7.5, '5', './images/cheesecake_640.jpg')
	]);
var $author$project$Main$init = {H: $author$project$Main$availableProducts, l: 0, q: _List_Nil, E: 0};
		...
		switch (msg.$) {
			case 0:
				...
				return _Utils_update(
					...
					{
						l: model.l + p.M,
						q: A2($elm$core$List$cons, p, model.q)
					});
			case 2:
				return _Utils_update(
					model,
					{l: 0, q: _List_Nil, E: model.E + model.l});
			default:
				var _v1 = model.q;
				if (!_v1.b) {
					return model;
					...
					return _Utils_update(
						model,
						{l: model.l - lastAdded.M, q: rest});
				}
		}
	});
var $author$project$Main$OrderPayed = {$: 2};
var $author$project$Main$ProdectOrderUndone = {$: 1};
...
var $author$project$Main$ProductOrdered = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Main$productView = function (product) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Main$ProductOrdered(product)),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src(product.Y)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$p,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('available-list')
									]),
								A2(
									$elm$core$List$map,
									function (p) {
										return A2(
											...
											_List_fromArray(
												[
													$author$project$Main$productView(p)
												]));
									},
									model.H))
							])),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$ProdectOrderUndone)
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$OrderPayed)
									]),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										'Total Order: ' + $elm$core$String$fromFloat(model.l))
									])),
								A2(
								$elm$html$Html$p,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text(
										'TOTAL: ' + $elm$core$String$fromFloat(model.E))
									]))
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('currently-ordered-list')
							]),
						_List_fromArray(
							[
								A2(
